...
@section('title','修改权限'.$permission->name_cn)
@section('content')
            ...
            <div class="tpl-block ">
                <div class="am-g tpl-amazeui-form">
                    <div class="am-u-sm-12 am-u-md-9">
                        <form class="am-form am-form-horizontal" action="{{url('permissions/'.$permission->id)}}" method="post">
                            {{csrf_field()}}
                            {{method_field('put')}}
                            <div class="am-form-group">
                                <label for="user-name" class="am-u-sm-3 am-form-label">权限中文名</label>
                                <div class="am-u-sm-9">
                                    <input type="text" name="name_cn" required maxlength="64" value="{{$permission->name_cn}}"
                                           placeholder="权限中文名">
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" name="name" required maxlength="64" value="{{$permission->name_cn}}"
                                           placeholder="权限英文名">
                                </div>
                            </div>
                            <div class="am-form-group">
