...
@section('content')
    <div class="tpl-content-wrapper">
        ...
        <ol class="am-breadcrumb">
            ...
            <li><a href="{{ url('/courses/create') }}">添加课程</a></li>
                            ...
                            @if(!empty($courses->count()))
                                @foreach($courses as $course)
                                    <tr>
                                        ...
                                        <td class="am-hide-sm-only">{{$course->classroom??'无'}}</td>
                                        <td class="am-hide-sm-only">{{$course->updated_at}}</td>
                                        <td>
