    ...
    init: {
        'FilesAdded': function (up, files) {
            ...
            plupload.each(files, function (file) {
                $('#pickQiNiu1').before('<li id="' + file.id + '"><img src="/loading.gif" alt=""><a class="imgDelBtn" href="javascript:void(0)" onclick="imgDelQiNiu($(this))"></a></li>');
            });
        },
